...
var NRS = (function(NRS, $, undefined) {
		...
		if (NRS.inApp) {
			if (NRS.appPlatform && NRS.appVersion) {
				...
				if (new Date() > noticeDate) {
					...
					var downloadUrl = "https://github.com/float-team/floatcoin/releases";
	...
	NRS.downloadClientUpdate = function(version) {
		...
		if (NRS.inApp) {
			...
			$("#nrs_update_iframe").attr("src", "https://github.com/float-team/floatcoin/releases/download/" + NRS.downloadedVersion.versionNr + "/floatcoin-" + NRS.downloadedVersion.versionNr + ".zip");
