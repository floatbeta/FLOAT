...
public final class Constants {
	...
	public static int FLOAT_DIFF_ADJUST_CHANGE_BLOCK = 2700;
	
	public static long FLOAT_REWARD_RECIPIENT_ASSIGNMENT_START_BLOCK = 6500;
    public static long FLOAT_REWARD_RECIPIENT_ASSIGNMENT_WAIT_TIME = 4;
    
    public static long FLOAT_ESCROW_START_BLOCK = 0; // not sure when these were enabled, but they each do an alias lookup every block if greater than the current height
    public static long FLOAT_SUBSCRIPTION_START_BLOCK = 0;
    public static int FLOAT_SUBSCRIPTION_MIN_FREQ = 3600;
    public static int FLOAT_SUBSCRIPTION_MAX_FREQ = 31536000;
