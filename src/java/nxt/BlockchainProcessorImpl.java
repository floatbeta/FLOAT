...
final class BlockchainProcessorImpl implements BlockchainProcessor {
	public static final int BLOCKCACHEMB = Nxt.getIntProperty("float.blockCacheMB") == 0 ? 40 : Nxt.getIntProperty("blockCacheMB");
	public static boolean oclVerify = Nxt.getBooleanProperty("float.oclVerify");
	public static final int oclThreshold = Nxt.getIntProperty("float.oclThreshold") == 0 ? 50 : Nxt.getIntProperty("float.oclThreshold");
	public static final int oclWaitThreshold = Nxt.getIntProperty("float.oclWaitThreshold") == 0 ? 2000 : Nxt.getIntProperty("float.oclWaitThreshold");
