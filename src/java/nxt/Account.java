...
public final class Account {
    ...
    public static void setRewardRecipientAssignment(Long id, Long recipient) {
    	...
    	if(assignment == null) {
    		assignment = new RewardRecipientAssignment(id, id, recipient, (int) (currentHeight + Constants.FLOAT_REWARD_RECIPIENT_ASSIGNMENT_WAIT_TIME));
    	}
    	else {
    		assignment.setRecipient(recipient, (int) (currentHeight + Constants.FLOAT_REWARD_RECIPIENT_ASSIGNMENT_WAIT_TIME));
    	}
