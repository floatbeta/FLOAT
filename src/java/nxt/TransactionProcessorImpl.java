...
final class TransactionProcessorImpl implements TransactionProcessor {
    ...
    private static final int rebroadcastAfter = Nxt.getIntProperty("float.rebroadcastAfter") != 0 ? Nxt.getIntProperty("float.rebroadcastAfter") : 4;
    private static final int rebroadcastEvery = Nxt.getIntProperty("float.rebroadcastEvery") != 0 ? Nxt.getIntProperty("float.rebroadcastEvery") : 2;
