...
public final class Nxt {
    ...
    static {
        System.out.println("Initializing Float server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        Logger.logShutdownMessage("Float server " + VERSION + " stopped.");
        Logger.shutdown();
    }
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("Float server " + VERSION + " started successfully.");
                if (Constants.isTestnet) {
                    Logger.logMessage("RUNNING ON TESTNET - DO NOT USE REAL ACCOUNTS!");
                }
                if(Nxt.getBooleanProperty("float.mockMining")) {
