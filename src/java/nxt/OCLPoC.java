...
final class OCLPoC {
    ...
    private static final int hashesPerEnqueue = Nxt.getIntProperty("float.oclHashesPerEnqueue") == 0 ? 1000 : Nxt.getIntProperty("float.oclHashesPerEnqueue");
    private static final int memPercent = Nxt.getIntProperty("float.oclMemPercent") == 0 ? DEFAULT_MEM_PERCENT : Nxt.getIntProperty("float.oclMemPercent");
    ...
    static {
        try {
            boolean autoChoose = Nxt.getBooleanProperty("float.oclAuto", true);
            ...
            if(autoChoose) {
                ...
                platformIndex = Nxt.getIntProperty("float.oclPlatform");
                deviceIndex = Nxt.getIntProperty("float.oclDevice");
            }
