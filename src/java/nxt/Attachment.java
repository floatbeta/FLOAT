...
public interface Attachment extends Appendix {
    ...
    public final static class FloatMiningRewardRecipientAssignment extends AbstractAttachment {
    	
    	FloatMiningRewardRecipientAssignment(ByteBuffer buffer, byte transactionVersion) {
    		super(buffer, transactionVersion);
    	}
    	
    	FloatMiningRewardRecipientAssignment(JSONObject attachmentData) {
    		super(attachmentData);
    	}
    	
    	public FloatMiningRewardRecipientAssignment() {
    	}
        ...
        @Override
        public TransactionType getTransactionType() {
            return TransactionType.FloatMining.REWARD_RECIPIENT_ASSIGNMENT;
        }
    }
